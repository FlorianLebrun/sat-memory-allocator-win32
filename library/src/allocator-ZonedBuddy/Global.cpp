...
void ZonedBuddyAllocator::Global::Cache::init(SAT::IHeap* pageHeap, int pageID)
{
  SizeMapping::init();
  this->pageID = pageID;
  this->pageSize = 1 << SAT::cSegmentSizeL2;
  ...
  this->base_cache_1.init(this, &this->base_cache_0);
  this->base_cache_1.init_zoning();

  this->base_cache_2.init(this, &this->base_cache_1);
  this->base_cache_2.init_zoning();

  this->base_cache_3.init(this, &this->base_cache_2);
  this->base_cache_3.init_zoning();

  this->base_cache_4.init(this, &this->base_cache_3);
  this->base_cache_4.init_zoning();

  this->base_cache_5.init(this, &this->base_cache_3);
  this->base_cache_5.init_zoning();

  this->base_cache_6.init(this, &this->base_cache_3);
  this->base_cache_6.init_zoning();

  this->base_cache_7.init(this, &this->base_cache_3);
  this->base_cache_7.init_zoning();
}

int ZonedBuddyAllocator::Global::Cache::getCachedSize() {
  int size = 0;
...
void ZonedBuddyAllocator::Global::Cache::flushCache() {
  this->base_cache_7.flushCache();
  this->base_cache_6.flushCache();
  this->base_cache_5.flushCache();
  this->base_cache_4.flushCache();
  this->base_cache_3.flushCache();
  this->base_cache_2.flushCache();
  this->base_cache_1.flushCache();
