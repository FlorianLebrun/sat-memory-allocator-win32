...
namespace ZonedBuddyAllocator {
  ...
  const int baseSizeL2 = SAT::cSegmentSizeL2 - baseCountL2;
  ...
  const int supportSizeL2 = SAT::cSegmentSizeL2 - 1;
  ...
  static_assert(sizeof(tSATEntry) == SAT::cEntrySize, "Bad tSATEntry size");
